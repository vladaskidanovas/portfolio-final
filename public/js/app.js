...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    key: "CLoadThemeFromLocalStorage",
    value: function CLoadThemeFromLocalStorage() {
    ...
    */
    ...
    key: "WPBackgroundParalax",
    value: function WPBackgroundParalax(e) {
      var elem = document.querySelector(".background-wrapper");
      ...
      if (elem) {
        ...
        var top = "".concat((_mouseX - _w) / _w * 5, "%");
        var left = "".concat((_mouseY - _h) / _h * 5, "%");
